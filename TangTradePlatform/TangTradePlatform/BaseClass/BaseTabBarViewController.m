...
@interface BaseTabBarViewController ()<UserLanguageChange,UITabBarControllerDelegate>
...
- (NSArray *)dataArray {
    ...
    _dataArray = @[home,trade,me];
    return _dataArray;
}

- (void)languageSet {
    NSArray *imageArray = @[@"home",@"trade",@"me"];
...
- (void)setName:(NSString *)name image:(NSString *)image toVC:(UIViewController *)vc {
    ...
    [vc.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:RGBColor(137, 137, 137, 1),NSForegroundColorAttributeName,[UIFont systemFontOfSize:12],NSFontAttributeName, nil] forState:UIControlStateNormal];
