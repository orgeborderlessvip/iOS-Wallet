...
//    [self test];
    ...
    if (![WDBaseFileControl haveLocal]) {
        ...
        _window.rootViewController = [[UINavigationController alloc] initWithRootViewController:[WDLoginAppViewController new]];
    }
    
    [_window makeKeyAndVisible];
    
    [WDBaseWalletCommand test];
    
//    [WDRecordRankingView show];
