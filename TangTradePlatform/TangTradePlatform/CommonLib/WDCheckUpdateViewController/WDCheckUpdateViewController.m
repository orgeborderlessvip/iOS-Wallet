...
- (void)viewDidLoad {
    ...
    /*NSString *updateString = WDLocalizedString(@"检测到新版本:");
    updateString = [NSString stringWithFormat:@"%@%@",updateString,_model.iosversion];
    NSString *versionString = WDLocalizedString(@"当前版本:");
    versionString = [NSString stringWithFormat:@"%@%@",versionString,_model.appVersion];
    NSString *updateDetailString = WDLocalizedString(@"更新内容:");
    
    [dataArray insertObject:updateDetailString atIndex:0];
    [dataArray insertObject:versionString atIndex:0];
    [dataArray insertObject:updateString atIndex:0];*/
