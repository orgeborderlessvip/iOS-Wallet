...
- (void)languageSet {
    ...
    NSString *balance = [NSString stringWithFormat:@"%@:",WDLocalizedString(@"余额")];
    NSString *account = [NSString stringWithFormat:@"%@:",WDLocalizedString(@"账户")];
    NSString *amount = [NSString stringWithFormat:@"%@:",WDLocalizedString(@"数量")];
    _titleLabel.text = title;
    _balanceLabel.text = balance;
    _accountLabel.text = account;
    _amountLabel.text = amount;
    [_sendButton setTitle:title forState:(UIControlStateNormal)];
    NSString *head = [NSString stringWithFormat:@"%@:",WDLocalizedString(@"手续费")];
