...
#import "WDReceptionViewModel.h"
#import "WDUploadGetHistoryModel.h"
#import "WDNetworkManager.h"
@implementation WDReceptionViewModel
...
- (void)loadData {    
    ...
    model.api_code = [NSString stringWithFormat:@"%s",cHttpMethod[HTTP_COMMAND_LIST_Receive_Change]];
...
- (void)loadTestData {
    NSData *data = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"test1" ofType:@"json"]];
