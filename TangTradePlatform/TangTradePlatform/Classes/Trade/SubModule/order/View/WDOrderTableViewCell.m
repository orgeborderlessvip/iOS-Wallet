...
- (void)setModel:(WDOrderTableDataModel *)model {
    ...
    _bdsLabel.text = model.coinTotalAmount;
    _bdsBTCLabel.text = model.coinAmount;
    _riseTimeButton.text = [model.riseTime stringByReplacingOccurrencesOfString:@"T" withString:@" "];
}
