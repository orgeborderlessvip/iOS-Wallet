...
- (void)setAllInfoArray:(NSArray *)allInfoArray DataArray:(NSArray *)totalDataArray index:(NSInteger)index {
    self.viewModel.allInfoArray = allInfoArray;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self.navigationController pushViewController:({
        WDBuy_SellBaseViewController *vc = [WDBuy_SellBaseViewController new];
        
        WDTradeDataModel *base = self.dataArray[indexPath.section];
        
        vc.baseCoin = base.base;
        
        vc.quetoCoin = base.quote;
